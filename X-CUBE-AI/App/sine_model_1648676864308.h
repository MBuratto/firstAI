/**
  ******************************************************************************
  * @file    sine_model_1648676864308.h
...
#ifndef AI_SINE_MODEL_1648676864308_H
#define AI_SINE_MODEL_1648676864308_H
#pragma once

#include "sine_model_1648676864308_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINE_MODEL_1648676864308_MODEL_NAME          "sine_model_1648676864308"
#define AI_SINE_MODEL_1648676864308_ORIGIN_MODEL_NAME   "sine_model"

/******************************************************************************/
#define AI_SINE_MODEL_1648676864308_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_SINE_MODEL_1648676864308_IN_NUM        (1)
#define AI_SINE_MODEL_1648676864308_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_MODEL_1648676864308_IN_SIZE { \
  AI_SINE_MODEL_1648676864308_IN_1_SIZE, \
}
#define AI_SINE_MODEL_1648676864308_IN_SIZE_BYTES { \
  AI_SINE_MODEL_1648676864308_IN_1_SIZE_BYTES, \
}
#define AI_SINE_MODEL_1648676864308_IN_1_HEIGHT      (1)
#define AI_SINE_MODEL_1648676864308_IN_1_WIDTH       (1)
#define AI_SINE_MODEL_1648676864308_IN_1_CHANNEL     (1)
#define AI_SINE_MODEL_1648676864308_IN_1_SIZE        (1 * 1 * 1)
#define AI_SINE_MODEL_1648676864308_IN_1_SIZE_BYTES  (AI_SINE_MODEL_1648676864308_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_MODEL_1648676864308_OUT_NUM       (1)
#define AI_SINE_MODEL_1648676864308_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_MODEL_1648676864308_OUT_SIZE { \
  AI_SINE_MODEL_1648676864308_OUT_1_SIZE, \
}
#define AI_SINE_MODEL_1648676864308_OUT_SIZE_BYTES { \
  AI_SINE_MODEL_1648676864308_OUT_1_SIZE_BYTES, \
}
#define AI_SINE_MODEL_1648676864308_OUT_1_HEIGHT      (1)
#define AI_SINE_MODEL_1648676864308_OUT_1_WIDTH       (1)
#define AI_SINE_MODEL_1648676864308_OUT_1_CHANNEL     (1)
#define AI_SINE_MODEL_1648676864308_OUT_1_SIZE        (1 * 1 * 1)
#define AI_SINE_MODEL_1648676864308_OUT_1_SIZE_BYTES  (AI_SINE_MODEL_1648676864308_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_MODEL_1648676864308_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup sine_model_1648676864308
 ...
 * @ingroup sine_model_1648676864308
 ...
 */
AI_API_ENTRY
ai_bool ai_sine_model_1648676864308_get_info(
 ...
 */
AI_API_ENTRY
ai_error ai_sine_model_1648676864308_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_sine_model_1648676864308_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_sine_model_1648676864308_destroy(ai_handle network);

/*!
 * @brief Initialize the data structures of the network.
 * @ingroup sine_model_1648676864308
 * @details This API initialized the network after a successfull
 * @ref ai_sine_model_1648676864308_create. Both the activations memory buffer 
 ...
 * using @ref ai_sine_model_1648676864308_get_error
 */
AI_API_ENTRY
ai_bool ai_sine_model_1648676864308_init(
 ...
 * header generated by the code generation tool. See AI_SINE_MODEL_1648676864308_*
 * defines into file @ref sine_model_1648676864308.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sine_model_1648676864308_run(
 ...
 */
AI_API_ENTRY
ai_i32 ai_sine_model_1648676864308_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINE_MODEL_1648676864308_H */
