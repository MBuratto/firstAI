/**
  ******************************************************************************
  * @file    sine_model_1648676864308.c
...
#include "sine_model_1648676864308.h"
...
#define AI_NET_OBJ_INSTANCE g_sine_model_1648676864308
 
#undef AI_SINE_MODEL_1648676864308_MODEL_SIGNATURE
#define AI_SINE_MODEL_1648676864308_MODEL_SIGNATURE     "d1f43451913f3e51a2955d41507d6dbe"
...
#define AI_TOOLS_DATE_TIME   "Wed Mar 30 18:48:21 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SINE_MODEL_1648676864308_N_BATCHES
#define AI_SINE_MODEL_1648676864308_N_BATCHES         (1)
...
AI_STATIC ai_array serving_default_dense_6_input0_output_array;   /* Array #0 */
...
AI_STATIC ai_array dense_0_weights_array;   /* Array #6 */
AI_STATIC ai_array dense_0_bias_array;   /* Array #7 */
AI_STATIC ai_array dense_1_weights_array;   /* Array #8 */
AI_STATIC ai_array dense_1_bias_array;   /* Array #9 */
AI_STATIC ai_array dense_2_weights_array;   /* Array #10 */
AI_STATIC ai_array dense_2_bias_array;   /* Array #11 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor serving_default_dense_6_input0_output;   /* Tensor #0 */
...
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #6 */
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #7 */
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 128, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_1648676864308_IN_NUM, &serving_default_dense_6_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_1648676864308_OUT_NUM, &dense_2_output),
  &dense_0_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool sine_model_1648676864308_configure_activations(
...
AI_DECLARE_STATIC
ai_bool sine_model_1648676864308_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SINE_MODEL_1648676864308_MODEL_NAME,
      .model_signature   = AI_SINE_MODEL_1648676864308_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= sine_model_1648676864308_configure_weights(net_ctx, &params->params);
  ok &= sine_model_1648676864308_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_sine_model_1648676864308_forward(ai_handle network, const ai_buffer* input)
{
